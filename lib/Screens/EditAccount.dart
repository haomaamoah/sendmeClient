...
import 'package:sendmeClient/Screens/MyDrawer.dart';
    ...
    return WillPopScope(
      onWillPop: (){
        ...
        return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(
            builder: (context)=>user==null? HomePage():MapScreen( errand)
        ), (route) => false);
      },
                                      ...
                                      onPressed: () {
                                        ...
                                        FileUtils.saveToFile('${user.fname}||${user.lname}||${user.uname}||${user.email}||${user.country}').then(
                                                (value) => Navigator.pushReplacement(context,
                                                    MaterialPageRoute(builder: (context) => MapScreen(errand)))
                                        );
